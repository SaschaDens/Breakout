...
public class Finished extends Layout {
    private JLabel BG;
    private JButton btnRestart, btnChooseChar;
    
    public Finished(GameController controller, GameModel model) {
        setName("Finished");
        setLayout(null);
    ...
    public void paintComponent(Graphics g) {
        ...
        g2d.drawImage(Functions.loadIMG("/Views/Finished.jpg"), 0, 0, null);
